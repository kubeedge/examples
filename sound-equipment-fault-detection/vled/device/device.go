...
import (
	...
	dbInflux "github.com/kubeedge/examples/sound-equipment-fault-detection/vled/data/dbmethod/influxdb2"
	dbMysql "github.com/kubeedge/examples/sound-equipment-fault-detection/vled/data/dbmethod/mysql"
	dbRedis "github.com/kubeedge/examples/sound-equipment-fault-detection/vled/data/dbmethod/redis"
	dbTdengine "github.com/kubeedge/examples/sound-equipment-fault-detection/vled/data/dbmethod/tdengine"
	httpMethod "github.com/kubeedge/examples/sound-equipment-fault-detection/vled/data/publish/http"
	mqttMethod "github.com/kubeedge/examples/sound-equipment-fault-detection/vled/data/publish/mqtt"
	"github.com/kubeedge/examples/sound-equipment-fault-detection/vled/data/stream"
	"github.com/kubeedge/examples/sound-equipment-fault-detection/vled/driver"
