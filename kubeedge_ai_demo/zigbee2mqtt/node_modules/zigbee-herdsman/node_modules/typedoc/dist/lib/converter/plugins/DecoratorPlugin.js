    ...
    onDeclaration(context, reflection, node) {
        ...
        node.decorators.forEach((decorator) => {
            ...
            if (type && type.symbol) {
                ...
                info.type = new index_1.ReferenceType(info.name, fqn);
                ...
                this.usages[fqn].push(new index_1.ReferenceType(reflection.name, index_1.ReferenceType.SYMBOL_FQN_RESOLVED, reflection));
            }
